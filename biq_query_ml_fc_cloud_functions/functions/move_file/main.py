...
def move_file(data, context):
    ...
    source_bucket_name =  os.getenv('SOURCE_BUCKET')  #'u4cast-cr-files-source-1651866920' #
    source_bucket = CS.get_bucket(source_bucket_name)
    source_blob = source_bucket.blob(file_name)

    destination_bucket_name = os.getenv('DESTINATION_BUCKET') #'u4cast-cr-files-flush-1654283799'  
